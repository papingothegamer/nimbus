...
// A sleek, flat toggle button resembling Inspector's toggle switches (e.g., Warp, Loop)
class InspectorToggleButton : public juce::Button {
public:
    InspectorToggleButton(const juce::String& name);
    void paintButton(juce::Graphics& g, bool shouldDrawButtonAsHighlighted, bool shouldDrawButtonAsDown) override;
};

// A sleek number box that allows clicking and dragging to change values (like Inspector's transpose/gain boxes)
class InspectorNumberBox : public juce::Component {
public:
    InspectorNumberBox();
    ~InspectorNumberBox() override;
...
public:
    InspectorPanel(const juce::String& title);
...
class InspectorVerticalGainSlider : public juce::Slider {
public:
    InspectorVerticalGainSlider();
    ~InspectorVerticalGainSlider() override;
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(InspectorVerticalGainSlider)
};
